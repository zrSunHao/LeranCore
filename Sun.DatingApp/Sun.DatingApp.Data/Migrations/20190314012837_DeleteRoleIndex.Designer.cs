...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190314012837_DeleteRoleIndex")]
    partial class DeleteRoleIndex
    {
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9510fcf8-cd30-4680-91d7-c97689f8d287"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 9, 28, 36, 850, DateTimeKind.Local).AddTicks(1926),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("e73d8306-4013-4049-8a71-54683d726e47"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 9, 28, 36, 851, DateTimeKind.Local).AddTicks(1845),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("f6a17c7b-4812-43f9-91a3-e2fc161209af"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 9, 28, 36, 851, DateTimeKind.Local).AddTicks(1853),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
