...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190303062848_PermissionEntityAddParentId")]
    partial class PermissionEntityAddParentId
    {
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c5d3feef-21cd-487f-9ac2-fcecf1071c94"),
                            Code = "SuperAdmin",
                            CreatedAt = new DateTime(2019, 3, 3, 14, 28, 48, 278, DateTimeKind.Local).AddTicks(1309),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("786d1e42-a3f6-4ddc-b7cb-d83e2a91eb2e"),
                            Code = "Admin",
                            CreatedAt = new DateTime(2019, 3, 3, 14, 28, 48, 279, DateTimeKind.Local).AddTicks(581),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("a7bc72c7-f492-4720-8bb3-74bb835176ba"),
                            Code = "User",
                            CreatedAt = new DateTime(2019, 3, 3, 14, 28, 48, 279, DateTimeKind.Local).AddTicks(588),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
