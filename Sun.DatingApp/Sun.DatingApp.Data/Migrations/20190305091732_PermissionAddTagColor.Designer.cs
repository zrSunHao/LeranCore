...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190305091732_PermissionAddTagColor")]
    partial class PermissionAddTagColor
    {
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6bc2049c-9435-40c1-8cb4-0d5d27f39ac5"),
                            Code = "SuperAdmin",
                            CreatedAt = new DateTime(2019, 3, 5, 17, 17, 32, 609, DateTimeKind.Local).AddTicks(4853),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("de9c3a5c-7578-49a4-b6c2-c047b8e1939b"),
                            Code = "Admin",
                            CreatedAt = new DateTime(2019, 3, 5, 17, 17, 32, 610, DateTimeKind.Local).AddTicks(4041),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("70740354-4bd4-40cf-8859-f5fc8430225a"),
                            Code = "User",
                            CreatedAt = new DateTime(2019, 3, 5, 17, 17, 32, 610, DateTimeKind.Local).AddTicks(4048),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
