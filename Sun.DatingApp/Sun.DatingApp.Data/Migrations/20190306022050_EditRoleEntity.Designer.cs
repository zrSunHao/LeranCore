...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190306022050_EditRoleEntity")]
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8968c88-c80d-42bf-9289-ff5b6c9d4b7f"),
                            Active = false,
                            Code = "SuperAdmin",
                            CreatedAt = new DateTime(2019, 3, 6, 10, 20, 50, 558, DateTimeKind.Local).AddTicks(6377),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("c1fecea0-9acd-41e8-9f9b-5f6d3f8d6caa"),
                            Active = false,
                            Code = "Admin",
                            CreatedAt = new DateTime(2019, 3, 6, 10, 20, 50, 560, DateTimeKind.Local).AddTicks(3123),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("970a0200-5a7a-4927-a6e5-52bda26e1037"),
                            Active = false,
                            Code = "User",
                            CreatedAt = new DateTime(2019, 3, 6, 10, 20, 50, 560, DateTimeKind.Local).AddTicks(3131),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
