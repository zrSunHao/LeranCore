...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190314122044_EditAccountEntity")]
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3e448529-e345-4932-8fea-23631be60b46"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 20, 20, 44, 80, DateTimeKind.Local).AddTicks(746),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("e2cda2f7-f825-41eb-96cf-a86817139e1c"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 20, 20, 44, 81, DateTimeKind.Local).AddTicks(6936),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("1dd9a482-ce20-4007-997b-2e05caf8eeac"),
                            Active = false,
                            CreatedAt = new DateTime(2019, 3, 14, 20, 20, 44, 81, DateTimeKind.Local).AddTicks(6987),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
