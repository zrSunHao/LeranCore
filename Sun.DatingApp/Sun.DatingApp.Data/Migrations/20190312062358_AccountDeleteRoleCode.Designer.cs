...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190312062358_AccountDeleteRoleCode")]
    partial class AccountDeleteRoleCode
    {
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bd377ff4-0420-4256-9207-ba90a371a272"),
                            Active = false,
                            Code = "SuperAdmin",
                            CreatedAt = new DateTime(2019, 3, 12, 14, 23, 58, 516, DateTimeKind.Local).AddTicks(4956),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("edee40d5-f4af-4214-a6b1-26a7493e2ed4"),
                            Active = false,
                            Code = "Admin",
                            CreatedAt = new DateTime(2019, 3, 12, 14, 23, 58, 517, DateTimeKind.Local).AddTicks(4545),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("317d7376-5a9f-487a-92ab-9b470168a91b"),
                            Active = false,
                            Code = "User",
                            CreatedAt = new DateTime(2019, 3, 12, 14, 23, 58, 517, DateTimeKind.Local).AddTicks(4552),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
