...
namespace Sun.DatingApp.Data.Migrations
{
    ...
    [Migration("20190307061917_Add_MenuAndPage_Entity")]
    partial class Add_MenuAndPage_Entity
    {
            ...
            modelBuilder.Entity("Sun.DatingApp.Data.Entities.System.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b4182f80-76d7-4b13-8b06-e1d2d14d3c45"),
                            Active = false,
                            Code = "SuperAdmin",
                            CreatedAt = new DateTime(2019, 3, 7, 14, 19, 17, 401, DateTimeKind.Local).AddTicks(9455),
                            Deleted = false,
                            Intro = "超级管理员拥有所有的权限",
                            Name = "超级管理员"
                        },
                        new
                        {
                            Id = new Guid("8a2730f4-3a11-4763-8caf-05ed0f31e4ee"),
                            Active = false,
                            Code = "Admin",
                            CreatedAt = new DateTime(2019, 3, 7, 14, 19, 17, 407, DateTimeKind.Local).AddTicks(1714),
                            Deleted = false,
                            Intro = "管理员用于管理用户权限",
                            Name = "管理员"
                        },
                        new
                        {
                            Id = new Guid("af94bdf9-92b9-4183-a1d6-699cfe2bed9c"),
                            Active = false,
                            Code = "User",
                            CreatedAt = new DateTime(2019, 3, 7, 14, 19, 17, 407, DateTimeKind.Local).AddTicks(1728),
                            Deleted = false,
                            Intro = "可以使用基本功能",
                            Name = "用户"
                        });
